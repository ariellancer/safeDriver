        ...
        <>
            <View style={styles.container}>
                <View style={styles.timerContainer}>
                    <Text
                        style={styles.timerText}>{`${timeNew.hours < 10 ? '0' : ''}${timeNew.hours}:${(timeNew.minutes % 60) < 10 ? '0' : ''}${timeNew.minutes % 60}:${(timeNew.seconds % 60) < 10 ? '0' : ''}${timeNew.seconds % 60}`}</Text>
                </View>
                <View style={styles.numberOfNotFocus}>
                    <Text style={styles.unFocusedText}>Unfocused: {prev}</Text>
                </View>
                <TouchableOpacity style={isDrivingNew ? styles.endDrivingButton : styles.startDrivingButton}
                                  onPress={isDrivingNew ? handleEndDriving : handleStartDriving}>
